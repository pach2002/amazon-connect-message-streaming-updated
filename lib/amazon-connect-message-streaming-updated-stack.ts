import { Duration, Stack, StackProps, CfnParameter, RemovalPolicy, CfnOutput} from 'aws-cdk-lib';
...
export class AmazonConnectMessageStreamingUpdatedStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const debugLog = new CfnParameter(this, 'debugLog', {
    ...
    if(enableSMS){
      ...
      inboundSMSTopic.addSubscription(
        new subs.LambdaSubscription(inboundMessageFunction)
      );
      new CfnOutput(this, 'SmsInboundTopic', {
    ...
    if(enableFB || enableWhatsApp){
      ...
      if(enableFB){
        ...
        new CfnOutput(this, 'FacebookApiGatewayWebhook', {
      ...
      if(enableWhatsApp){
        ...
        new CfnOutput(this, 'WhatsAppApiGatewayWebhook', {
      ...
      if(digitalOutboundMsgStreamingTopic){
        digitalOutboundMsgStreamingTopic.addSubscription(
          new subs.LambdaSubscription(outboundMessageFunction, {
            filterPolicy: {
